...
if upload_type not in ('attachments', 'data'):
...
mime_type = mimetypes.guess_type(file_to_upload)[0] or 'text/plain'
...
try:
    ...
    print(f'Problem uploading: {e} ({type(e)}) content: {e.response_content}')
